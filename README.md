...
- Usage: python3 irsseq.py [bamcount file list: control] [bamcount file list: treated] [genome FASTA file name] [output file name] [OPTIONAL:-m if exons on the minus strand are sorted in ascending order]<br>
